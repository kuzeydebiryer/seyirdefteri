// Simple Icons projesinden (simpleicons.org) — açık kaynaklı, marka bağlantısı
// vermek için tasarlanmış SVG glif seti. currentColor kullanıyor, çevresindeki
// metinle aynı rengi alıyor (site paletiyle uyumlu kalsın diye Letterboxd'un
// resmi neon yeşili yerine).
export default function LetterboxdIkon({ className = 'h-4 w-4' }) {
  return (
